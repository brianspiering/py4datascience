...
# Note: This shell script comes with no warranty or support. It is just an aid to help you create a reproducible enirovnment for the workshop. Your computer might not play nice with it, and this script depends on The Internet which changes.